...
sum_elections <- function(settlement_sums){
...
# names <- unique(res[c("max_col_name_1","max_col_name_2","max_col_name_3","max_col_name_4")])
names <- unique(unlist(Kneset25_summed[c("max_col_name_1","max_col_name_2","max_col_name_3","max_col_name_4")]))
# names <- res %>% distinct(max_col_name_1,max_col_name_2,max_col_name_3,max_col_name_4,.keep_all = TRUE)
names
...
Kneset25_summed2 <- Kneset25_summed
...
Kneset25_summed2 <- process_knesset_data(Kneset25_summed2,coalition_names,opposition_names)
...
settlement_sums <- sum_columns(Kneset24, which(names(Kneset24) == "Avoda"), which(names(Kneset24) == "Tikva_Hadasha"))

res <- sum_elections(settlement_sums)
# res
```
...
# Example usage: Sum columns from 'Avoda' to 'Ale_yarok'
settlement_sums <- sum_columns(Kneset23, which(names(Kneset23) == "Avoda"), which(names(Kneset23) == "Shas"))
...
# Example usage: Sum columns from 'Avoda' to 'Ale_yarok'
settlement_sums <- sum_columns(Kneset22, which(names(Kneset22) == "Avoda"), which(names(Kneset22) == "Shas"))
...
# Example usage: Sum columns from 'Avoda' to 'Ale_yarok'
settlement_sums <- sum_columns(Kneset20, which(names(Kneset20) == "Mahane_Zioni"), which(names(Kneset20) == "Shas"))
