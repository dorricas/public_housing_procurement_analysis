...
Purchuses_Elections <- Purchuses_Elections %>%
  dplyr::select(lamas_name, year, x3_rooms_apartments, x4_rooms_apartments, x3_average_paid_in_Mil, x4_average_paid_in_Mil, sum_apartments, total_paid_in_Mil, first.party, second.party, third.party, forth.party, first.party.percentage, second.party.percentage, third.party.percentage, forth.party.percentage, coalition.support, BZB, Vote.precentage)
...
crPlots(coalition_votePer_model)
```


```{r}
# poisson regression: predict log of num apartments purchased by coalition support and BZB
coalition_BZB_model <- glm(sum_apartments ~ coalition.support + BZB, data = Purchuses_Elections, family = poisson)
summary(coalition_BZB_model)
crPlots(coalition_BZB_model)
```
...
```{r}
# selected model: coalition_sumApt_model, df: Purchuses_Elections
summary(coalition_sumApt_model)
```
...
ggplot(data_year_2017, aes(x = coalition.support, y = sum_apartments)) +
  geom_point(alpha = 0.2, color = "#F06543") +  # Increase alpha transparency and change point color
  geom_smooth(aes(color = "Smoothing Curve"), 
              method = 'glm', method.args = list(family = 'poisson'), se = TRUE, linetype = "solid") +  # Adjust line type for smooth curve
  labs(title = "Coalition Support vs Sum of Apartments in 2017",  # Improve title
       x = "Coalition Support",
       y = "Sum of Apartments") +
  scale_color_manual(values = c("Smoothing Curve" = "#F06543"), guide = FALSE) +  # Manually set color for smooth curve and hide legend
...
ggplot(data_year_2018, aes(x = coalition.support, y = sum_apartments)) +
  geom_point(alpha = 0.2, color = "#F09D51") +  # Increase alpha transparency and change point color
  geom_smooth(aes(color = "Smoothing Curve"), 
              method = 'glm', method.args = list(family = 'poisson'), se = TRUE, linetype = "solid") +  # Adjust line type for smooth curve
  labs(title = "Coalition Support vs Sum of Apartments in 2018",  # Improve title
       x = "Coalition Support",
       y = "Sum of Apartments") +
  scale_color_manual(values = c("Smoothing Curve" = "#F09D51"), guide = FALSE) +  # Manually set color for smooth curve and hide legend
  theme_minimal() +  # Use minimal theme for cleaner appearance
  theme(plot.title = element_text(size = 16, face = "bold"),  # Adjust title size and style
        axis.title = element_text(size = 14),  # Adjust axis label size
        axis.text = element_text(size = 12))  # Adjust axis tick label size
...
ggplot(data_year_2019, aes(x = coalition.support, y = sum_apartments)) +
  geom_point(alpha = 0.2, color = "#7ACB23") +  # Increase alpha transparency and change point color
  geom_smooth(aes(color = "Smoothing Curve"), 
              method = 'glm', method.args = list(family = 'poisson'), se = TRUE, linetype = "solid") +  # Adjust line type for smooth curve
  labs(title = "Coalition Support vs Sum of Apartments in 2019",  # Improve title
       x = "Coalition Support",
       y = "Sum of Apartments") +
  scale_color_manual(values = c("Smoothing Curve" = "#7ACB23"), guide = FALSE) +  # Manually set color for smooth curve and hide legend
  theme_minimal() +  # Use minimal theme for cleaner appearance
  theme(plot.title = element_text(size = 16, face = "bold"),  # Adjust title size and style
        axis.title = element_text(size = 14),  # Adjust axis label size
        axis.text = element_text(size = 12))  # Adjust axis tick label size
...
ggplot(data_year_2020, aes(x = coalition.support, y = sum_apartments)) +
  geom_point(alpha = 0.2, color = "#43DF9B") +  # Increase alpha transparency and change point color
  geom_smooth(aes(color = "Smoothing Curve"), 
              method = 'glm', method.args = list(family = 'poisson'), se = TRUE, linetype = "solid") +  # Adjust line type for smooth curve
  labs(title = "Coalition Support vs Sum of Apartments in 2020",  # Improve title
       x = "Coalition Support",
       y = "Sum of Apartments") +
  scale_color_manual(values = c("Smoothing Curve" = "#43DF9B"), guide = FALSE) +  # Manually set color for smooth curve and hide legend
  theme_minimal() +  # Use minimal theme for cleaner appearance
  theme(plot.title = element_text(size = 16, face = "bold"),  # Adjust title size and style
        axis.title = element_text(size = 14),  # Adjust axis label size
        axis.text = element_text(size = 12))  # Adjust axis tick label size
...
ggplot(data_year_2021, aes(x = coalition.support, y = sum_apartments)) +
  geom_point(alpha = 0.2, color = "#50F4EB") +  # Increase alpha transparency and change point color
  geom_smooth(aes(color = "Smoothing Curve"), 
              method = 'glm', method.args = list(family = 'poisson'), se = TRUE, linetype = "solid") +  # Adjust line type for smooth curve
  labs(title = "Coalition Support vs Sum of Apartments in 2021",  # Improve title
       x = "Coalition Support",
       y = "Sum of Apartments") +
  scale_color_manual(values = c("Smoothing Curve" = "#50F4EB"), guide = FALSE) +  # Manually set color for smooth curve and hide legend
  theme_minimal() +  # Use minimal theme for cleaner appearance
  theme(plot.title = element_text(size = 16, face = "bold"),  # Adjust title size and style
        axis.title = element_text(size = 14),  # Adjust axis label size
        axis.text = element_text(size = 12))  # Adjust axis tick label size
...
ggplot(data_year_2022, aes(x = coalition.support, y = sum_apartments)) +
  geom_point(alpha = 0.2, color = "#4F65FA") +  # Increase alpha transparency and change point color
  geom_smooth(aes(color = "Smoothing Curve"), 
              method = 'glm', method.args = list(family = 'poisson'), se = TRUE, linetype = "solid") +  # Adjust line type for smooth curve
  labs(title = "Coalition Support vs Sum of Apartments in 2022",  # Improve title
       x = "Coalition Support",
       y = "Sum of Apartments") +
  scale_color_manual(values = c("Smoothing Curve" = "#4F65FA"), guide = FALSE) +  # Manually set color for smooth curve and hide legend
  theme_minimal() +  # Use minimal theme for cleaner appearance
  theme(plot.title = element_text(size = 16, face = "bold"),  # Adjust title size and style
        axis.title = element_text(size = 14),  # Adjust axis label size
        axis.text = element_text(size = 12))  # Adjust axis tick label size
...
ggplot(data_year_2023, aes(x = coalition.support, y = sum_apartments)) +
  geom_point(alpha = 0.2, color = "#BE23CC") +  # Increase alpha transparency and change point color
  geom_smooth(aes(color = "Smoothing Curve"), 
              method = 'glm', method.args = list(family = 'poisson'), se = TRUE, linetype = "solid") +  # Adjust line type for smooth curve
  labs(title = "Coalition Support vs Sum of Apartments in 2023",  # Improve title
       x = "Coalition Support",
       y = "Sum of Apartments") +
  scale_color_manual(values = c("Smoothing Curve" = "#BE23CC"), guide = FALSE) +  # Manually set color for smooth curve and hide legend
  theme_minimal() +  # Use minimal theme for cleaner appearance
  theme(plot.title = element_text(size = 16, face = "bold"),  # Adjust title size and style
        axis.title = element_text(size = 14),  # Adjust axis label size
        axis.text = element_text(size = 12))  # Adjust axis tick label size
...
ggplot(data_year_2024, aes(x = coalition.support, y = sum_apartments)) +
  geom_point(alpha = 0.2, color = "#FF00E6") +  # Increase alpha transparency and change point color
  geom_smooth(aes(color = "Smoothing Curve"), 
              method = 'glm', method.args = list(family = 'poisson'), se = TRUE, linetype = "solid") +  # Adjust line type for smooth curve
  labs(title = "Coalition Support vs Sum of Apartments in 2024",  # Improve title
       x = "Coalition Support",
       y = "Sum of Apartments") +
  scale_color_manual(values = c("Smoothing Curve" = "#FF00E6"), guide = FALSE) +  # Manually set color for smooth curve and hide legend
  theme_minimal() +  # Use minimal theme for cleaner appearance
  theme(plot.title = element_text(size = 16, face = "bold"),  # Adjust title size and style
        axis.title = element_text(size = 14),  # Adjust axis label size
        axis.text = element_text(size = 12))  # Adjust axis tick label size
