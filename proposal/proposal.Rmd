...
In which regions there are more vacant apartments?  
Did those regions vote for the elected government?  
...
ggplot(data = Properties_room_sum_filtered, mapping = aes(x = reorder(city_lms_name, -total), y = total, fill = total)) +
  ...
  labs(x = "City name", y = "Total apartments", title = "Total apartments by City", subtitle = "Where there are more than 100 apartments in the city") +
